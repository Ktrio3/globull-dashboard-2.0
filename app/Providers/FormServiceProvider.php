...
class FormServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Form::component('bsRadio', 'components.form.radio', ['name', 'label' => null, 'value', 'default', 'attributes']);
        Form::component('bsSelect', 'components.form.select', ['name', 'label' => null, 'value', 'default' => [], 'placeholder' => null, 'attributes' => []]);
